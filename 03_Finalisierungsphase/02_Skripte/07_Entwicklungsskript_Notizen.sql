...
('Ayzada El Kaypnazar', 'Mainzer Straße 10, 55257 Budenheim', '1997-06-29', 'ayzada.elkaypnazar@swap-style.de', '015112345678', 'Benutzer'),

('Furkan Demir', 'Jahnstraße 17, 55257 Budenheim', '2000-03-13', 'furkan.demir@swap-style.de', '015123456789', 'Administrator'),

('Emirhan Demir', 'Jahnstraße 17, 55257 Budenheim', '2008-07-06', 'emirhan.demir@swap-style.de', '015134567890', 'Benutzer'),

('Aydin Ünal', 'Rheinstraße 8, 55257 Budenheim', '1992-01-27', 'aydin.unal@swap-style.de', '015145678901', 'Benutzer'),

('Damla Ünal', 'Waldstraße 22, 55257 Budenheim', '1997-05-18', 'damla.unal@swap-style.de', '015156789012', 'Benutzer'),

('Ugur Gursoy', 'Binger Straße 15, 55257 Budenheim', '1983-02-27', 'ugur.gursoy@swap-style.de', '015167890123', 'Benutzer'),

('Ahmet Balakci', 'Gartenstraße 30, 55257 Budenheim', '1979-12-24', 'ahmet.balakci@swap-style.de', '015178901234', 'Benutzer'),

('Edwin Brons', 'Mombacher Straße 45, 55257 Budenheim', '1989-09-09', 'edwin.brons@swap-style.de', '015189012345', 'Benutzer'),

('Annisa Demir', 'Schulstraße 12, 55257 Budenheim', '2003-11-17', 'annisa.demir@swap-style.de', '015190123456', 'Benutzer'),

('Irmak Kordel', 'Parkallee 6, 55257 Budenheim', '1985-06-21', 'irmak.kordel@swap-style.de', '015201234567', 'Benutzer'),

('Burcu Kabacam', 'Hauptstraße 5, 55257 Budenheim', '1985-08-03', 'burcu.kabacam@swap-style.de', '015212345678', 'Benutzer'),

('Ensar Togru', 'Wilhelmstraße 23, 55257 Budenheim', '1999-10-18', 'ensar.togru@swap-style.de', '015223456789', 'Benutzer');
...
('Budenheim', '55257', 'Mainzer Straße 10'),

('Budenheim', '55257', 'Jahnstraße 17'),

('Budenheim', '55257', 'Rheinstraße 8'),

('Budenheim', '55257', 'Waldstraße 22'),

('Budenheim', '55257', 'Binger Straße 15'),

('Budenheim', '55257', 'Gartenstraße 30'),

('Budenheim', '55257', 'Mombacher Straße 45'),

('Budenheim', '55257', 'Schulstraße 12'),

('Budenheim', '55257', 'Parkallee 6'),

('Budenheim', '55257', 'Hauptstraße 5');
...
-- Buch 10 gibt es nicht mehr darum der Fehler
...
(1, '2026-05-06', 'Furkan Demir', 'Jahnstraße 17, 55257 Budenheim', 0.00),

(2, '2026-05-07', 'Emirhan Demir', 'Jahnstraße 17, 55257 Budenheim', 2.50),

(3, '2026-05-08', 'Aydin Ünal', 'Rheinstraße 8, 55257 Budenheim', 1.50),

(4, '2026-05-09', 'Damla Ünal', 'Waldstraße 22, 55257 Budenheim', 3.00),

(5, '2026-05-10', 'Ugur Gursoy', 'Binger Straße 15, 55257 Budenheim', 0.00),

(6, '2026-05-12', 'Ahmet Balakci', 'Gartenstraße 30, 55257 Budenheim', 2.00),

(7, '2026-05-14', 'Edwin Brons', 'Mombacher Straße 45, 55257 Budenheim', 1.00),

(8, '2026-05-15', 'Annisa Demir', 'Schulstraße 12, 55257 Budenheim', 2.50),

(9, '2026-05-16', 'Irmak Kordel', 'Parkallee 6, 55257 Budenheim', 0.00),

(10, '2026-05-17', 'Burcu Kabacam', 'Hauptstraße 5, 55257 Budenheim', 3.50);
...
UPDATE angebot ag
JOIN benutzer u ON ag.benutzer_id = u.benutzer_id
JOIN standort s ON CONCAT(s.adresse, ', ', s.postleitzahl, ' ', s.ort) = u.adresse
SET ag.standort_id = s.standort_id
 ...
 SELECT 
    ...
    u.name AS anbieter,
    u.adresse AS benutzeradresse,
    CONCAT(s.adresse, ', ', s.postleitzahl, ' ', s.ort) AS abholadresse,
    ag.versandoption
FROM angebot ag
JOIN buch b ON ag.buch_id = b.buch_id
JOIN benutzer u ON ag.benutzer_id = u.benutzer_id
